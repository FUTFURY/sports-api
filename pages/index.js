...
export default function Lobby() {
    ...
    useEffect(() => {
        fetchMatches();
        const intervalId = setInterval(() => fetchMatches(true), 5000);
                                    ...
                                    <div className="space-y-4 mb-6">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center justify-end gap-3 text-center">
                                                <span className="w-8 font-bold text-white text-lg leading-none">{match.sets_p1 ?? 0}</span>
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center justify-end gap-3 text-center">
                                                <span className="w-8 font-bold text-white text-lg leading-none">{match.sets_p2 ?? 0}</span>
