...
export default async function handler(req, res) {
    ...
    // Allow any origin by echoing it back, or fall back to *
    ...
    const { lng = "fr", sport = "1" } = req.query;
    console.log("DEBUG: get-live-games query:", req.query);
    console.log(`DEBUG: Fetching sport=${sport}`);

    // Use service-api mirror to bypass redirects/blocks
    const url = `https://sa.1xbet.com/service-api/LiveFeed/Get1x2_VZip?sports=${sport}&count=50&lng=${lng}&mode=4&country=1&partner=159&getEmpty=true&noFilterBlockEvent=true`;
